<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="IdentificazioneTossine.aspx.cs" Inherits="Holonet3.IdentificazioneTossine.IdentificazioneTossine" %>
...
<asp:Content ID="ContentBody" ContentPlaceHolderID="MainContent" runat="server">
    <asp:UpdatePanel ID="panUpdate" runat="server">
        <ContentTemplate>
			...
			<tr>
				<td>
					<asp:Label ID="lblCodice" runat="server" Text="Inserire il codice della Tossina da analizzare:"></asp:Label>
				</td>
				<td align="right">
