<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="NewIdentificazioneSostanze.aspx.cs" Inherits="Holonet3.IdentificazioneSostanze.NewIdentificazioneSostanze" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <table width="100%">
        <tr class="GridViewHeader">
            <td colspan="2" align="center">Identificazione Sostanze</td>
        </tr>
        <tr>
            <td valign="top">
