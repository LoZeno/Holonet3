<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="LoginHolonet.aspx.cs" Inherits="Holonet3.Account.LoginHolonet" Theme="TemaBlu" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    <%--<Holonet:Login ID="ucLogin" runat="server"></Holonet:Login>--%>
    <Holonet:QRLogin ID="qrLogin" runat="server"></Holonet:QRLogin>
    <asp:UpdatePanel ID="panHack" runat="server">
        <ContentTemplate>
            <Holonet:Hacking ID="ucHacking" runat="server" AccettaSpina="false" ParteDaHackerare="altro" LivelloHacking="0" Visible="true" />
        </ContentTemplate>
    </asp:UpdatePanel>
</asp:Content>
