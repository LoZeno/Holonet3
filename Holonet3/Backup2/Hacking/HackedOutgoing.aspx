<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="HackedOutgoing.aspx.cs" Inherits="Holonet3.Hacking.HackedOutgoing" %>
...
<%@ Register Src="~/Informatica/Decriptazione.ascx" TagPrefix="Holonet" TagName="ucDecrypt" %>
                ...
                <tr>
                    ...
                    <td valign="top" colspan="2">
                        <asp:Panel ID="panMessage" runat="server" Visible="false" Width="100%">
                            ...
                            <Holonet:ucDecrypt ID="ucDecrypt" runat="server" Visible="true" />
                        </asp:Panel>
